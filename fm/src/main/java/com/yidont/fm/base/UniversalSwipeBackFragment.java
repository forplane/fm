 ...
 * 有侧滑效果，有动态权限效果
 */
public abstract class UniversalSwipeBackFragment extends SwipeBackFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (null != mViewGroup || savedInstanceState != null) {
            if (mViewGroup == null) {
                mViewGroup = (ViewGroup) attachToSwipeBack(baseCreateView(inflater, container, savedInstanceState));
            } else {
