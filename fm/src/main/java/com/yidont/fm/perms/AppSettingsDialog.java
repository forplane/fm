...
public class AppSettingsDialog {
    ...
    public static class Builder {
        ...
        private Object _mActivityOrFragment;
         ...
         * enqueue to {@link AppSettingsDialog#show()}.
         */
        public AppSettingsDialog build() {
            return new AppSettingsDialog(_mActivityOrFragment, mContext, mRationale, mTitle,
